...
const DEFAULT_SETTINGS = {
  // Brand content
  logoImageUrl:'https://res.cloudinary.com/otcyc5vv/image/upload/v1788436723/White_Finnished_Logo.png',
  name: 'Zionova',
  ...
  instagram: 'https://www.instagram.com/zionova_officials',
  facebook: 'https://www.facebook.com/zionovaofficials',
  tiktok: 'https://www.tiktok.com/@zionova_officials',
  whatsapp: 'https://wa.me/94767055078',
  email: 'zionova.invo@gmail.com',
  // Design / theme (applied live across the storefront)
  heroTitle: 'Wear the <em>Future</em>.',
  ...
  stat1Value: '4.3★', stat1Label: 'Customer Rating',
  ...
  productsSubtitle: 'Premium cotton tees, designed and finished with signature Zionova gold detailing.',
  socialsLabel: 'Stay Connected', socialsTitle: 'Follow Zionova',
  socialsSubtitle: 'Join the community — new drops, behind the scenes, and exclusive offers.',
  footerCopyright: 'Zionova. All rights reserved.',
  colorBg: '#ffffff', colorText: '#000000', colorGold: '#c9a227',
  fontPair: 'playfair-poppins',
  heroImageUrl: 'https://res.cloudinary.com/otcyc5vv/image/upload/v1788346704/hero_image.png',
  aboutImageUrl: '',
  // Payments
  ...
  receiptThanksMessage: 'Thank you for shopping with Zionova — Wear the Future.',
  receiptFooterNote: '',
